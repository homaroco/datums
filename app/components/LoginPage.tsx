  ...
  return (
    <section ref={loginPageRef} className='login-page flex fixed justify-center items-center pt-[5px] top-0 w-full h-full z-30 overflow-auto bg-black'>
      ...
      <form onSubmit={login} className='flex flex-col'>
        {userEmail && userPassword && <span className="absolute top-[280px] mx-[20px]">
          <input type='checkbox' id='rememberCredentials' checked={rememberCredentials} onChange={() => setRememberCredentials(!rememberCredentials)} />
          <label htmlFor='rememberCredentials' className="pl-[5px] pb-[2px]">Remember me</label>
        </span>}
