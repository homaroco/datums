...
export default function Datum({
  ...
  return (
    ...
    >
      ...
      <span className="flex">
        <span className="flex items-center text-xs ml-[10px] text-neutral-600">
          {getTimestamp(Number(createdAt))}
        </span>
        <button
          className="flex items-center justify-center text-2xl ml-[10px]"
      ...
      {isMenuOpen && (
        <div
          className="click-away-listener fixed top-0 left-0 right-0 bottom-0 z-20"
